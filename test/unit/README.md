...
| 6 | **`shouldIgnore`/`DEFAULT_IGNORE`** glob matcher (incl. `dir/**` deep nesting) | `path-keys.js` | ignored junk in subfolders; `*.mirall.part`/`*~` on copy |
