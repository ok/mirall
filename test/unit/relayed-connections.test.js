...
test("a relayed socket through the configured key is 'own' and carries the configured label", (t) => {
  ...
  t.is(snap.connections[0].peerKey, b4a.toString(PEER, 'hex'))
