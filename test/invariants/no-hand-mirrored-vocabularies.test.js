...
// identity-limits.js is not on this list: it moved INTO the contract package, so it imports
// ./limits.js as a sibling and the "points at contract/" assertion no longer describes it.
