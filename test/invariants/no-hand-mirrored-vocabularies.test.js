...
test('every mirrored module points at the contract package', (t) => {
  for (const [file] of MIRRORED) {
    // A file already inside contract/ imports its sibling as ./limits.js, which this regex cannot
    // match. It is still held to the re-declaration rule above — that is the half that matters.
    if (file.startsWith('shared/contract/')) continue
