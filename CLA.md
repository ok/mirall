...
terms for your present and future Contributions to the project.

You retain ownership of the copyright in your Contribution. This Agreement only
grants the licenses set out below.

**1. Definitions.**
"You" means the individual or legal entity signing this Agreement. "Maintainer"
means Oliver Kohl and/or the Mirall legal entity. "Contribution" means any
original work of authorship, including modifications or additions to existing
work, that You intentionally submit to the project for inclusion.
...
derivative works. This license expressly permits the Maintainer to license Your
Contribution under the GNU AGPL-3.0 **and** under separate commercial terms
(dual licensing).
...
Contribution, where such license applies only to patent claims licensable by
You that are necessarily infringed by Your Contribution alone or by combination
with the project. If any entity institutes patent litigation alleging that the
project or a Contribution infringes a patent, the patent licenses granted under
this Agreement to that entity terminate.

**4. Your representations.**
You represent that You are legally entitled to grant the above licenses; that
each Contribution is Your original creation; and that, if Your employer has
rights to intellectual property You create, You have received permission to
make Contributions on behalf of that employer, or that employer has waived such
rights.

**5. Support and warranties.**
You are not expected to provide support for Your Contributions. Except for the
representations in Section 4, Contributions are provided "AS IS" without
