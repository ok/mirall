...
/**
 * @typedef {Record<'clearMembership' | 'ownedMounts' | 'shares' | 'foreignMounts' | 'forget', () => Promise<void>>} LeaveSteps
 */

/**
 * @param {string} spaceId
 * @param {LeaveSteps} steps
 * @param {{ log?: Logger, onPhase?: (phase: string) => void }} [opts]
 */
