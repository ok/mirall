...
// through a bee and a real disk, and so a caller holding a pre-read record need not re-read it.
//
...
//   5. outside the space's pinned download folder → not downloaded, KEEP: re-pinning the old
//                                  folder must restore the status. Keys on the space's OVERRIDE,
//                                  never the effective root — changing the global folder must not
//                                  un-download every space that never opted in.
