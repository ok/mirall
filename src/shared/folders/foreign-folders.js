...
import { statusForFaultCode, STATUS_MOUNT_GONE } from './mount-fault.js'
...
import {
  initForeignPause,
  pauseMount,
  pauseMountForIoError,
  recordMirrorScanFault,
  isAutoPaused,
  autoPauseForeignMountGone,
  resumeAutoPausedForeignMount,
} from './foreign-pause.js'
