 ...
 *
 * Split by who reports the failure. Reveal, pause and unmount are handed to controls as
 * `() => void`, so they go through useRunAction and their failure becomes a toast. Delete, rename
 * and relocate REJECT on purpose: the confirm dialog and the edit modal report those themselves,
 * and a toast here as well would tell the user twice.
 */
