// An action aimed at SpaceScreen from somewhere else — a command fired on the folder screen, a
// "mirror this folder" from the folder screen's own menu. SpaceScreen owns the dialogs behind them,
...
export type PendingSpaceAction =
  ...
  // Carries the share's id, not the share: by the time SpaceScreen reads it the listing is the
