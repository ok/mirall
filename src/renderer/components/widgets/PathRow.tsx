    ...
    <div className="flex items-center gap-3">
      ...
      {onAction && (
        <button
          ...
          className="shrink-0 bg-surface-container-high dark:bg-surface-container-highest text-accent rounded-xl px-5 py-3.5 font-headline font-bold text-sm hover:bg-surface-container-hover active:scale-95 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-secondary/30"
        >
