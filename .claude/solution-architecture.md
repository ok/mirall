...
| `components/` | `primitives/`, `cards/`, `modals/`, `layout/`, `folder/`, `space/`, `path/`, `activity/`, `share-drop/`, `settings/`, `toast/` (§10) |
