...
| `src/shared/transfer/backends/overlay/loose-downloads.js` | The loose consumer side: peer-catalog list / watch, active-transfer reconcile, the `looseChannel`, `looseDownload`, the engine slot and forwarders |
